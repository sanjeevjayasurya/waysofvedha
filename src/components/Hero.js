...
export default function Hero() {
  return (
    <section class="w-screen bg-black flex justify-center items-center flex-col p-10">
      <div class="relative inline-flex group">
        ...
        <Link
          href="#"
          title="Get quote now"
          class="relative inline-flex rounded-[40px] items-center justify-center px-4 py-2 text-lg font-semibold text-black transition-all duration-200 bg-white font-pj focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
          role="button"
        >
          <span>
